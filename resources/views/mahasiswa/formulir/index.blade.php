                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y">
                        ...
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-2">
                                <a href="{{ route('formulir-mahasiswa.review', $formulir->id) }}" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg focus:outline-none focus:shadow-outline-gray" aria-label="Review">
                                    Review PDF
                                </a>
                            </td>
                            ...
                            <td>
                                ...
                                <a href="{{ route('formulir-mahasiswa.print', $formulir->id) }}" class="flex px-2 py-2 text-sm font-medium leading-5 text-green-600 rounded-lg focus:outline-none focus:shadow-outline-gray" aria-label="Print">
                                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
